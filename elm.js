...
var $author$project$HomePage$initialModel = {page_state: 0};
...
var $author$project$StartUp$startUp = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
										...
										[
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$elm$html$Html$text('Starte jetzt dein Trainig'),
															A2(
															$elm$html$Html$div,
															_List_fromArray(
																[
...
var $author$project$HomePage$view = function (model) {
	...
	if (!_v0) {
		return A2(
			...
			_List_Nil,
			_List_fromArray(
				[$author$project$MenuBar$menuBar, $author$project$StartUp$startUp]));
	} else {
		return A2(
			$elm$html$Html$div,
			_List_Nil,
