...
var $author$project$HomePage$initialModel = function (_v0) {
	return _Utils_Tuple2(
		{errorMessage: $elm$core$Maybe$Nothing, learnData: _List_Nil, learnProgress: _List_Nil, page_state: 0},
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'DataReceived':
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{learnData: learningData, page_state: 1}),
						$elm$core$Platform$Cmd$none);
				} else {
			...
			case 'SaveLocalStorage':
				return _Utils_Tuple2(
					model,
					$author$project$HomePage$save('abc'));
			default:
				return _Utils_Tuple2(
					model,
...
var $author$project$QuestionHandler$answers = function (lst) {
	if (lst.$ === 'Just') {
		var lstl = lst.a;
		...
		if (_v1.$ === 'Just') {
			...
			return A2(
				...
				A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$text(qst)
						])),
				$author$project$QuestionHandler$answers(
...
var $author$project$QuestionHandler$questionView = function (question) {
	if (question.$ === 'Just') {
		var message = question.a;
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
												...
												[
													...
													_List_fromArray(
														[
															...
															_List_fromArray(
																[
																	$elm$html$Html$text(message.question)
																])),
															A2(
															$elm$html$Html$p,
															_List_fromArray(
															...
															_List_Nil,
															$author$project$QuestionHandler$answers(
																$elm$core$Maybe$Just(message.answers)))
														]))
												]))
										]))
								]))
		...
		return $elm$html$Html$text('No question available');
	}
};
var $author$project$Messages$SendHttpRequest = {$: 'SendHttpRequest'};
													...
													[
																	...
																	[
																		...
																		_List_fromArray(
																			[
																				...
																				$fapian$elm_html_aria$Html$Attributes$Aria$ariaValueNow(25),
														...
														_List_fromArray(
															[
																...
																$elm$html$Html$Events$onClick($author$project$Messages$SendHttpRequest)
															]),
														_List_fromArray(
															[
		...
		case 1:
			return A2(
				...
				_List_fromArray(
					[
						$author$project$MenuBar$menuBar,
						$author$project$QuestionHandler$questionView(
						$elm$core$List$head(model.learnData))
					]));
		default:
			return A2(
				$elm$html$Html$div,
...
var $author$project$HomePage$main = $elm$browser$Browser$element(
	{
		init: $author$project$HomePage$initialModel,
